...
<div class="form-group">
    ...
    <input type="text" name="cuerpo" id="cuerpo" class="form-control" placeholder="Cuerpo de Publicacion">
</div>
<div class="form-group">
    <label for="Role">Usuario-Nombre</label>
    <select name="usuarios_id" id="usuarios_id" class="form-control selectpicker" data-livesearch="true">
        ...
        <option value="{{$usuario2->id}}">{{$usuario2->nombre}}</option>
    @endforeach
    </select>
<div class="form-group">
